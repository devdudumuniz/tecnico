...
<section class="vh-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="valida/login.php" method="POST">
          <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
            <p class="lead fw-normal mb-0 me-3">Login T.I</p>
          </div>

          <div class="divider d-flex align-items-center my-4">
            <p class="text-center fw-bold mx-3 mb-0">T.I</p>
          </div>
          ...
          <div class="form-outline mb-3">
            <input name="senha" type="password" id="form3Example4" class="form-control form-control-lg"
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="form-check mb-0">
              <input name="lembreme" class="form-check-input me-2" type="checkbox" id="form2Example3" />
  ...
  <div
    ...
    <div class="text-white mb-3 mb-md-0">
      Copyright © 2020. Todos os direitos reservados a DM Tech.
    </div>
    <!-- Copyright -->
