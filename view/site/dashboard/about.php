...
<body class="goto-here">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html"><Img style="width:6vw;max-height:3rem;" src="../../assets/images/logo.png" alt="logo"></Img></a>
  ...
  <section id="home-section" class="hero">
    <div class="float col-md-9 ftco-animate text-center">
      ...
      <div class="slider-item js-fullheight">
        ...
        <div class="container-fluid p-0">
          <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
            <img class="one-third order-md-last img-fluid" src="../../assets/images/bg/menina.png" alt="menina">
            <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <div class="text">
                ...
                <div class="horizontal">
                  ...
                  <p><a href="#" class="btn-custom">Conheça Agora</a></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-7 py-md-5 wrap-about pb-md-5 ftco-animate">
          <div class="heading-section-bold mb-4 mt-md-5">
            <div class="ml-md-0">
              <h2 class="mb-4">Estabelecido desde 2022</h2>
            </div>
          </div>
          <div class="pb-md-5 pb-4">
            <p>A DM Tech é uma empresa líder em desenvolvimento de software com mais de 15 anos de experiência no mercado. Sua especialidade é o desenvolvimento de inteligência artificial voltada para crianças com autismo e dificuldades de desenvolvimento.</p>
            <p> Além disso, a empresa também oferece serviços de desenvolvimento de software em diversas linguagens de programação, atendendo as mais diversas demandas de seus clientes. Com uma equipe altamente capacitada e tecnologia de ponta, a DM Tech está sempre em busca de soluções inovadoras e eficientes para seus clientes, tornando-se uma referência no mercado de tecnologia.</p>
            <p><a href="#" class="btn btn-primary">Contribuir</a></p>
          </div>
        </div>
      </div>
    </div>
